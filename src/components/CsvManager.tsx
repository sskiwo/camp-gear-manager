    ...
    reader.onload = async (event) => {
      try {
        ...
        for (let i = 1; i < lines.length; i++) {
          ...
          const isConsumable = cols[8] === '1' || cols[8]?.toLowerCase() === 'true';
          const productUrl = cols[9] || `https://www.amazon.co.jp/s?k=${encodeURIComponent(productName)}`;
